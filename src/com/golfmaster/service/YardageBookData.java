...
{	
	...
	ArrayList<YardageBookData.ShotData> listShotField = new ArrayList<YardageBookData.ShotData>(
	...
	public String processRequest(HttpServletRequest request)
	{
		...
		try {
			...
			YardageBook.ParamData paramData = ydb.new ParamData("", "", "", 0.0, 0.0);
		...
		/*
		YardageBookData.ParamData paramData = new YardageBookData.ParamData();
