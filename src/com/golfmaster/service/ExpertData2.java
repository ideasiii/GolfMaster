...
public class ExpertData2 extends DeviceData{
...
//						hasKey = false;
	...
	private JSONObject queryExpertData(){
		...
		strSQL = "SELECT * FROM expert WHERE shot_data_id = (SELECT max(id) FROM shot_data WHERE Player = 'irit');" ;
